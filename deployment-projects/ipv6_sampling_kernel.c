...
{
    u64 addr =  - 0x7c6e93a0 + ctx->r12 * 0x8;
    sampling(addr, ctx->ip);
    return 0;
}
...
{
    u64 addr =  - 0x7c6e81a0 + ctx->ax * 0x8;
    sampling(addr, ctx->ip);
    return 0;
}
...
SEC("kprobe/nf_defrag_ipv6_enable+0x30")
int BPF_KPROBE(do_mov_3697)
{
    u64 addr = ctx->bx + 0xb34;
    sampling(addr, ctx->ip);
    return 0;
}


SEC("kprobe/nf_defrag_ipv6_enable+0x65")
...
SEC("kprobe/nf_defrag_ipv6_disable+0x29")
int BPF_KPROBE(do_mov_3699)
{
    u64 addr = ctx->r12 + 0xb34;
    sampling(addr, ctx->ip);
    return 0;
}


SEC("kprobe/defrag6_net_exit+0x29")
...
SEC("kprobe/nf_ct_frag6_gather+0x22d")
...
SEC("kprobe/nf_ct_frag6_gather+0x38f")
...
SEC("kprobe/nf_ct_frag6_gather+0x3c9")
...
SEC("kprobe/nf_ct_frag6_gather+0x3cd")
...
SEC("kprobe/nf_ct_frag6_gather+0x4b2")
...
SEC("kprobe/nf_ct_frag6_gather+0x4b9")
int BPF_KPROBE(do_mov_3708)
{
    u64 addr = ctx->r15 + 0x91;
    sampling(addr, ctx->ip);
    return 0;
}


SEC("kprobe/nf_ct_frag6_gather+0x508")
...
SEC("kprobe/nf_ct_frag6_gather+0x578")
...
SEC("kprobe/nf_ct_frag6_gather+0x5c6")
...
SEC("kprobe/nf_ct_frag6_gather+0x5f0")
...
SEC("kprobe/nf_ct_frag6_gather+0x642")
...
SEC("kprobe/nf_ct_frag6_gather+0x6bc")
...
SEC("kprobe/nf_ct_frag6_gather+0x6cf")
...
SEC("kprobe/nf_ct_frag6_gather+0x72d")
...
SEC("kprobe/nf_ct_frag6_gather+0x7c7")
...
SEC("kprobe/nf_ct_frag6_gather+0x815")
...
SEC("kprobe/nf_ct_frag6_gather+0x83b")
...
SEC("kprobe/nf_ct_frag6_gather+0x84e")
...
SEC("kprobe/nf_ct_frag6_gather+0x87f")
...
SEC("kprobe/nf_ct_frag6_gather+0x89f")
...
SEC("kprobe/nf_ct_frag6_gather+0x9ce")
...
SEC("kprobe/nf_ct_frag6_expire+0x100")
...
SEC("kprobe/nf_ct_net_pre_exit+0x36")
...
SEC("kprobe/nf_ct_net_init+0x59")
...
SEC("kprobe/nf_ct_net_init+0x65")
...
SEC("kprobe/nf_ct_net_init+0xd9")
...
SEC("kprobe/nf_ct_net_init+0xe2")
...
SEC("kprobe/nf_ct_net_init+0xeb")
...
SEC("kprobe/nf_ct_net_init+0x10d")
...
SEC("kprobe/nf_reject_ip6hdr_put+0x45")
...
SEC("kprobe/nf_reject_ip6hdr_put+0x5c")
...
SEC("kprobe/nf_reject_ip6hdr_put+0x6e")
...
SEC("kprobe/nf_reject_ip6hdr_put+0x72")
...
SEC("kprobe/nf_reject_ip6hdr_put+0x80")
...
SEC("kprobe/nf_reject_ip6hdr_put+0x88")
...
SEC("kprobe/nf_reject_ip6_tcphdr_put+0x2c")
int BPF_KPROBE(do_mov_3752)
{
    u64 addr = ctx->di + 0xb6;
    sampling(addr, ctx->ip);
    return 0;
}


SEC("kprobe/nf_reject_ip6_tcphdr_put+0x45")
...
SEC("kprobe/nf_reject_ip6_tcphdr_put+0x67")
...
SEC("kprobe/nf_reject_ip6_tcphdr_put+0x70")
...
SEC("kprobe/nf_reject_ip6_tcphdr_put+0x73")
...
SEC("kprobe/nf_reject_ip6_tcphdr_put+0x95")
...
SEC("kprobe/nf_reject_ip6_tcphdr_put+0xec")
...
SEC("kprobe/nf_reject_ip6_tcphdr_put+0x10a")
...
SEC("kprobe/nf_reject6_fill_skb_dst+0x80")
...
SEC("kprobe/nf_send_unreach6+0x189")
...
SEC("kprobe/nf_reject_skb_v6_tcp_reset+0x9c")
...
SEC("kprobe/nf_reject_skb_v6_tcp_reset+0xe0")
...
SEC("kprobe/nf_reject_skb_v6_tcp_reset+0xfd")
...
SEC("kprobe/nf_reject_skb_v6_tcp_reset+0x100")
...
SEC("kprobe/nf_reject_skb_v6_tcp_reset+0x110")
...
SEC("kprobe/nf_reject_skb_v6_tcp_reset+0x11c")
...
SEC("kprobe/nf_reject_skb_v6_tcp_reset+0x12c")
...
SEC("kprobe/nf_reject_skb_v6_tcp_reset+0x147")
...
SEC("kprobe/nf_reject_skb_v6_unreach+0x199")
...
SEC("kprobe/nf_reject_skb_v6_unreach+0x1d9")
...
SEC("kprobe/nf_reject_skb_v6_unreach+0x1f6")
...
SEC("kprobe/nf_reject_skb_v6_unreach+0x1f9")
...
SEC("kprobe/nf_reject_skb_v6_unreach+0x209")
...
SEC("kprobe/nf_reject_skb_v6_unreach+0x215")
...
SEC("kprobe/nf_reject_skb_v6_unreach+0x222")
...
SEC("kprobe/nf_reject_skb_v6_unreach+0x23b")
...
SEC("kprobe/nf_reject_skb_v6_unreach+0x24e")
...
SEC("kprobe/nf_reject_skb_v6_unreach+0x264")
...
SEC("kprobe/nf_reject_skb_v6_unreach+0x2bb")
...
SEC("kprobe/nf_reject_skb_v6_unreach+0x348")
...
SEC("kprobe/nf_reject_skb_v6_unreach+0x419")
int BPF_KPROBE(do_mov_3800)
{
    u64 addr = ctx->ax + ctx->r8 * 0x1 - 0x4;
    sampling(addr, ctx->ip);
    return 0;
}


SEC("kprobe/nf_reject_skb_v6_unreach+0x42c")
int BPF_KPROBE(do_mov_3801)
{
    u64 addr = ctx->ax + ctx->r8 * 0x1 - 0x2;
    sampling(addr, ctx->ip);
    return 0;
}
...
SEC("kprobe/nf_send_reset6+0x23c")
...
SEC("kprobe/nf_send_reset6+0x248")
...
SEC("kprobe/nf_send_reset6+0x2d2")
...
SEC("kprobe/nf_send_reset6+0x2e2")
...
SEC("kprobe/nf_send_reset6+0x2f9")
...
SEC("kprobe/nf_send_reset6+0x366")
...
SEC("kprobe/nf_send_reset6+0x36f")
...
SEC("kprobe/nf_send_reset6+0x3ed")
...
SEC("kprobe/nft_reject_ipv6_eval+0x34")
...
SEC("kprobe/nft_fib6_flowi_init+0x3d")
...
SEC("kprobe/nft_fib6_flowi_init+0x49")
...
SEC("kprobe/nft_fib6_flowi_init+0xa8")
...
SEC("kprobe/nft_fib6_flowi_init+0xe1")
...
SEC("kprobe/nft_fib6_flowi_init+0xe5")
...
SEC("kprobe/nft_fib6_flowi_init+0xf3")
...
SEC("kprobe/nft_fib6_flowi_init+0xf7")
...
SEC("kprobe/nft_fib6_flowi_init+0x11e")
...
SEC("kprobe/nft_fib6_flowi_init+0x134")
...
SEC("kprobe/nft_fib6_eval+0x18c")
int BPF_KPROBE(do_mov_3840)
{
    u64 addr = ctx->ax + ctx->r15 * 0x4;
    sampling(addr, ctx->ip);
    return 0;
}
...
SEC("kprobe/nft_fib6_eval_type+0x6c")
