...
struct page *__alloc_pages_bpf(gfp_t gfp, unsigned int order, int preferred_nid,
							nodemask_t *nodemask)
{
	return __alloc_pages(gfp, order, preferred_nid, nodemask);
}
EXPORT_SYMBOL(__alloc_pages_bpf);

unsigned long __get_free_pages_bpf(gfp_t gfp_mask, unsigned int order)
{
	struct page *page;
...
EXPORT_SYMBOL(__get_free_pages_bpf);
